...
import com.sumx4ever.common.app.ToolbarActivity;
...
import com.sumx4ever.italker.factory.presenter.group.GroupCreatePresenter;
...
//            final Throwable cropError = UCrop.getError(data);
    ...
    private class Adapter extends RecyclerAdapter<GroupCreateContract.ViewModel> {
        ...
        @Override
        protected ViewHolder<GroupCreateContract.ViewModel> onCreateViewHolder(View root, int
                viewType) {
