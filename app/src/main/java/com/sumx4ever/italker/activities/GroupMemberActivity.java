...
import com.sumx4ever.common.app.PresenterToolbarActivity;
...
import com.sumx4ever.italker.factory.presenter.group.GroupMembersContract;
import com.sumx4ever.italker.factory.presenter.group.GroupMembersPresenter;
import com.sumx4ever.italker.frags.group.GroupMemberAddFragment;
...
public class GroupMemberActivity extends PresenterToolbarActivity<GroupMembersContract.Presenter>
    ...
    private static void show(Context context, String groupId, boolean isAdmin) {
        ...
        context.startActivity(new Intent(context, GroupMemberActivity.class)
                ...
                .putExtra(KEY_GROUP_ADMIN, isAdmin));
    }
