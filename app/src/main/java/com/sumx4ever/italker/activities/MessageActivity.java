...
import com.sumx4ever.italker.frags.message.ChatGroupFragment;
import com.sumx4ever.italker.frags.message.ChatUserFragment;
...
public class MessageActivity extends Activity {
    ...
    public static void show(Context context, Session session) {
        ...
        intent.putExtra(KEY_RECEIVER_IS_GROUP, session.getReceiverType() == Message
                .RECEIVER_TYPE_GROUP);
